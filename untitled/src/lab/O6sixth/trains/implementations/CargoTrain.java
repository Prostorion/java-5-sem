...
public class CargoTrain implements Train {
    ...
    public CargoTrain(Locomotive locomotive, TrainCar[] trainCars) {
        if (!isValid(trainCars, locomotive.getCarryingCapacity())) throw new IllegalArgumentException();
        this.locomotive = locomotive;
        this.trainCars = trainCars;
    }

    public CargoTrain(int carryingCapacity, TrainCar[] trainCars) {
    ...
    public CargoTrain(int carryingCapacityLocomotive, TrainCar.TYPE type, int numberOfTrainCars, int carryingCapacityTrainCars) {
