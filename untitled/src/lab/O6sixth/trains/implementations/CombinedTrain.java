...
public class CombinedTrain implements Train {
    private final Locomotive locomotive;
    private TrainCar[] trainCars;

    public CombinedTrain(Locomotive locomotive, TrainCar[] trainCars) {
        if (!isValid(trainCars, locomotive.getCarryingCapacity())) throw new IllegalArgumentException();
        this.locomotive = locomotive;
        this.trainCars = trainCars;
    }

    public CombinedTrain(int carryingCapacity, TrainCar[] trainCars) {
    ...
    public CombinedTrain(int carryingCapacityLocomotive, TrainCar.TYPE type, int numberOfTrainCars, int carryingCapacityTrainCars) {
        if (carryingCapacityLocomotive < numberOfTrainCars * carryingCapacityTrainCars)
    ...
    public boolean equals(Object o) {
        ...
        CombinedTrain that = (CombinedTrain) o;
